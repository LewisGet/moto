...
use Aedes\AddressBundle\Entity\Area;
use Aedes\AddressBundle\Form\AreaType;
...
class AreaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AedesAddressBundle:Area')->findAll();
     ...
     * @Method("POST")
     * @Template("AedesAddressBundle:Area:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AedesAddressBundle:Area')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AedesAddressBundle:Area:edit.html.twig")
     */
