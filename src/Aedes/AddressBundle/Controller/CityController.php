...
use Aedes\AddressBundle\Entity\City;
use Aedes\AddressBundle\Form\CityType;
...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AedesAddressBundle:City')->findAll();
     ...
     * @Method("POST")
     * @Template("AedesAddressBundle:City:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AedesAddressBundle:City')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AedesAddressBundle:City:edit.html.twig")
     */
