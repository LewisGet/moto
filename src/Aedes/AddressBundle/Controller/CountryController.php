...
namespace Aedes\AddressBundle\Controller;
...
use Aedes\AddressBundle\Entity\Country;
use Aedes\AddressBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AedesAddressBundle:Country')->findAll();
     ...
     * @Method("POST")
     * @Template("AedesAddressBundle:Country:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AedesAddressBundle:Country')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AedesAddressBundle:Country:edit.html.twig")
     */
